...
class SO102Follower(Robot):
    """
    SO-102 Follower Arm designed by Yu Donghan, basing on SO-101 Arm from TheRobotStudio and Hugging Face.
    """
    ...
    def __init__(self, config: SO102FollowerConfig):
        ...
        self.bus = FeetechMotorsBus(
            ...
            motors={
                ...
                "wrist_yaw": Motor(5, "sts325", norm_mode_body), # A new joint is added to SO-101
