...
def xlerobot_cameras_config() -> dict[str, CameraConfig]:
    return {
        ...
        #     index_or_path="/dev/video4", fps=30, width=320, height=240, rotation=Cv2Rotation.NO_ROTATION
        # ),
        # "right_wrist": OpenCVCameraConfig(
        #     index_or_path="/dev/video6", fps=30, width=320, height=240, rotation=Cv2Rotation.NO_ROTATION
        # ),  
        # "head": OpenCVCameraConfig(
        #     index_or_path="/dev/video2", fps=30, width=320, height=240, rotation=Cv2Rotation.NO_ROTATION
        # ),                     
...
@RobotConfig.register_subclass("xlerobot2_client")
@dataclass
class XLerobot2ClientConfig(RobotConfig):
    # Network Configuration
    remote_ip: str
    port_zmq_cmd: int = 5555
    port_zmq_observations: int = 5556
