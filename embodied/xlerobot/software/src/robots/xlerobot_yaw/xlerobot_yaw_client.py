...
from .config_xlerobot2 import XLerobot2Config, XLerobot2ClientConfig


class XLerobot2Client(Robot):
    config_class = XLerobot2ClientConfig
    name = "xlerobot2_client"

    def __init__(self, config: XLerobot2ClientConfig):
    ...
    def _state_ft(self) -> dict[str, type]:
        return dict.fromkeys(
            (
                ...
                "left_arm_wrist_yaw.pos",  # New joint
                ...
                "right_arm_wrist_yaw.pos",  # New joint
