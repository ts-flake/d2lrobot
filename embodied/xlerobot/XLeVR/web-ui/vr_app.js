...
AFRAME.registerComponent('controller-updater', {
  ...
  createAxisIndicators: function() {
    ...
    leftXTip.setAttribute('position', '0.08 0 0');
    ...
    leftYTip.setAttribute('position', '0 0.08 0');
    ...
    leftZTip.setAttribute('position', '0 0 0.08');
    ...
    rightXTip.setAttribute('position', '0.08 0 0');
    ...
    rightYTip.setAttribute('position', '0 0.08 0');
    ...
    rightZTip.setAttribute('position', '0 0 0.08');
        ...
        if (this.leftHand && this.leftHand.components && this.leftHand.components['tracked-controls']) {
            ...
            if (leftGamepad) {
                ...
                leftController.buttons = {
                    x: !!leftGamepad.buttons[4]?.pressed, // a button
                    y: !!leftGamepad.buttons[5]?.pressed, // b button
